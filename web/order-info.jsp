    ...
    <body>
        ...
        <div class="wrapper">
            <div class="card__order">
                ...
                <form class="user-info" action="editOrder?id=${orderId}" method="post">
                    ...
                    <div class="form-input">
                        ...
                        <div class="payment">
                            <span style="text-align: center"> COD
                            </span>
                        </div>
                    </div>
                    ...
                    <c:if test="${orderInfo.status == 'SUBMITTED'}">
                        <div class="card__action">
                            <button id="btn-save" class="button-buy hide" type="submit">Save</button>
                            <span class="button-buy" id="btn-edit" onclick="ShowEdit()" title="Edit order">Edit</span>
                            <span class="button-cancel" title="Cancel this order?" onclick="Cancel(${orderId})">Cancel</span>
                        </div>
                    </c:if>
                    <c:if test="${orderInfo.status == 'CONFIRMED'}">
                        <div class="card__action">
                            <span id="btn-save" class="button-buy" onclick="ReceivedOrder(${orderId})">Received</span>
                        </div>
                    </c:if>
                    <c:if test="${orderInfo.status == 'COMPLETED' && !orderInfo.isFeedback}">
                        <div class="card__action feedback-product">
                            <span id="btn-save" class="button-buy" onclick="Feedback(${orderId})">Feedback</span>
                        </div>
                    </c:if>
                </form>
            </div>
