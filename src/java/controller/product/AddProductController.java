...
public class AddProductController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(name.trim().isEmpty()||code.trim().isEmpty()|| detail.trim().isEmpty()){
            PrintWriter out = response.getWriter();
            out.print("Add Product Failed! Occurs when insert product...");
        }else{
            if(dao.insertProduct(name, price, image, code, categoryId, detail, sdf.format(new Date())) == 1){
