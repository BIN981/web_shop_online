...
// get all category blog
        List listCategory = dao.getBlogCategory(startDate, endDate);
        request.setAttribute("listCategory", listCategory);
//        get posted
        int posted = dao.countBlog(startDate, endDate);
        request.setAttribute("posted", posted);
// count all active
        int countAcitve = dao.countAllActive();
        request.setAttribute("countAcitve", countAcitve);

// get all category product
        List listCategoryProduct = dao.getAllProductCategory(startDate, endDate);
